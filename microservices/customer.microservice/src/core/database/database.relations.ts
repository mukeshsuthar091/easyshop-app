...
export const AddRelationship = async (config) => {
    ...
    db.Order.hasMany(db.OrderProd, { foreignKey: 'orderId', as: 'order_products' });
    ...
    db.Cart.belongsTo(db.User, { foreignKey: 'userId', constraints: true, onDelete: 'CASCADE' })
    db.User.hasMany(db.Cart, { foreignKey: 'userId' });

    db.Cart.belongsTo(db.User, { foreignKey: 'b_userId', constraints: true, onDelete: 'CASCADE' })
    db.User.hasMany(db.Cart, { foreignKey: 'b_userId' });

    db.Cart.belongsTo(db.Product, { foreignKey: 'productId', constraints: true, onDelete: 'CASCADE' })
    db.Product.hasMany(db.Cart, { foreignKey: 'productId' });

    db.Cart.belongsTo(db.ProdSize, { foreignKey: 'productSizeId', constraints: true, onDelete: 'CASCADE' })
    db.ProdSize.hasMany(db.Cart, { foreignKey: 'productSizeId' });

    db.Cart.belongsTo(db.ProdColor, { foreignKey: 'productColorId', constraints: true, onDelete: 'CASCADE' })
    db.ProdColor.hasMany(db.Cart, { foreignKey: 'productColorId' });
