...
export class ResponseHandler {
    ...
    SuccessJSONResponse(Res: Response, status_code: number, message: string, data: any) {
    ...
    ErrorJSONResponse(Res: Response, error: any) {
...
export function GenerateError(status_code: number, code: any, message: string, error: any) {
